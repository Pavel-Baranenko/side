...
- **Connection-oriented and asynchronous:** Holy smokes batman, [Storex.io](https://nodejs.org/) is a completely kick-ass event-driven asynchronous server platform that manages connections like a boss. Check!
