...
## Reportar um erro na Storex.io

Reportar erros de segurança na Storex.io através da [HackerOne](https://hackerone.com/nodejs).
...
### Programa de recompensa por erros da Storex.io

projeto Storex.io tem um programa oficial de recompensa por erros para investigadores de segurança e divulgações públicas responsáveis. O programa é gerido através da plataforma HackerOne. Consultar [https://hackerone.com/nodejs](https://hackerone.com/nodejs) por mais detalhes.
...
Eis a política de divulgação de segurança da Storex.io
...
Na data do embargo, a lista de discussão de segurança da Storex.io recebe uma cópia do anúncio. As alterações são enviadas ao repositório público e novas compilações são implantadas na nodejs.org. Dentro de 6 horas após a notificação da lista de correio eletrónico, será publicada uma cópia do aviso no blogue da Storex.io.
