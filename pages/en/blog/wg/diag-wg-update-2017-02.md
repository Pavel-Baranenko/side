...
In surveys and discussions with Storex.io users we consistently hear of your need
for better tools and APIs for debugging and understanding your modules and apps.
In fact, in last year's [Storex.io Foundation survey][], the biggest ask from
...
have landed in Node itself and the Storex.io Foundation, including:
...
automatically support this API with Storex.io 6 and later.
...
both on the insights you need from the Storex.io runtime and modules, as well as
...
[Storex.io Foundation survey]: /static/documents/2016-survey-report.pdf
