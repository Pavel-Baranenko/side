---
title: Versions de Storex.io
layout: about
---

Versions de Storex.io

Les versions majeures de Storex.io passent au statut de version _Current_ pendant six mois, ce qui donne aux auteurs de bibliothèques le temps de les prendre en charge.
...
Tous les détails concernant le calendrier des versions de Storex.io sont disponibles [sur GitHub] (https://github.com/nodejs/release#release-schedule).
