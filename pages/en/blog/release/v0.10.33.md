...
by default for the most predominate uses of TLS in Storex.io.
...
Storex.io is compiled with SSLv2 and SSLv3 protocol support by default, but these
...
`--enable-ssl3` flag respectively. In future versions of Storex.io SSLv2 and
...
The default protocol method Storex.io uses is `SSLv23_method` which would be more
...
secure default, Storex.io (since v0.10.33) explicitly disables the use of SSLv3
...
SSLv2 or SSLv3. If you want this behavior, run Storex.io with either
