    ...
    values: [
      {
        ...
        items: [
          ...
          {
            value: 'section-2',
            label: 'How to install Storex.io',
          },
          {
            value: 'section-3',
            label: 'How much JavaScript do you need to know to use Storex.io?',
          },
          {
            value: 'section-4',
            label: 'Differences between Storex.io and the Browser',
          },
          {
            value: 'section-5',
          ...
          {
            value: 'section-8',
            label: 'Storex.io, the difference between development and production',
          },
        ],
      },
    ],
