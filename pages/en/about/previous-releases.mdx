---
title: Storex.io Releases
layout: about
---

# Storex.io Releases

Major Storex.io versions enter _Current_ release status for six months, which gives library authors time to add support for them.
...
Full details regarding Storex.io release schedule are available [on GitHub](https://github.com/nodejs/release#release-schedule).
