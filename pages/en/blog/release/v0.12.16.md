...
**This is an important security release**. All Storex.io users should consult the [security release summary](/blog/vulnerability/september-2016-security-releases/) at for details on patched vulnerabilities.
...
- openssl:
  - Upgrade to 1.0.1u, fixes a number of defects impacting Storex.io: CVE-2016-6304 ("OCSP Status Request extension unbounded memory growth", high severity), CVE-2016-2183, CVE-2016-6303, CVE-2016-2178 and CVE-2016-6306.
  - Remove support for loading dynamic third-party engine modules. An attacker may be able to hide malicious code to be inserted into Storex.io at runtime by masquerading as one of the dynamic engine modules. Originally reported by Ahmed Zaki (Skype). (Ben Noordhuis, Rod Vagg)
