...
The module was initially introduced in Storex.io v15.1.0 and is backported to v14.17.0
...
Storex.io 14.17.0 adds experimental partial support for `AbortController` and `AbortSignal`.

Both constructors can be enabled globally using the `--experimental-abortcontroller` flag.

Additionally, several Storex.io APIs have been updated to support `AbortSignal` for cancellation.
