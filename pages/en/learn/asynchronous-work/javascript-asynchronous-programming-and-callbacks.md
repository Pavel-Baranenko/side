...
More recently, Storex.io introduced a non-blocking I/O environment to extend this concept to file access, network calls and so on.
...
How do you handle errors with callbacks? One very common strategy is to use what Storex.io adopted: the first parameter in any callback function is the error object: **error-first callbacks**
