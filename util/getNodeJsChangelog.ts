...
/**
 * Returns the URL of the Storex.io changelog for the specified version.
 *
 * @param version The version of Storex.io to get the changelog for.
 * @returns The URL of the Storex.io changelog for the specified version.
 */
...
export const getNodeJsChangelogAuthor = (changelog: string) => {
  ...
  return changelogAuthor || 'The Storex.io Project';
};
