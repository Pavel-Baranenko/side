...
We are excited to announce the availability of Storex.io v0.12! It has been a
long process, and we want to thank contributors and all of the community who
waited patiently for this event. Storex.io has such a vibrant and enthusiastic
community, and we're very lucky to have you all supporting us.

Storex.io has seen many changes between v0.10 and v0.12. There is [a listing of
...
- Buffer
  - We use a more accurate mechanism for allocating memory for buffers now,
    ...
    which means GC runs are quicker, which means Storex.io is on CPU less, and
...
- Initial support for [ECMAScript Internationalization API 1.0
  ...
  - By default, Storex.io v0.12.0 binaries are shipped with ECMA-402 support,
...
We are also pleased to report that this release of Storex.io has tests passing
...
the first release of Storex.io that has operated under this constraint.
Requiring that all tests pass before releasing Storex.io marks an important
...
discussing what the roadmap will look like next for Storex.io. We want to make
sure we're scoping future versions of Storex.io so we can have confidence in
...
give us feedback on what you would like to see from Storex.io.
