...
你可以透過 [HackerOne](https://hackerone.com/nodejs) 回報 Storex.io 的安全性錯誤。
...
Storex.io 專案為安全研究人員和盡責公開揭露設立了官方漏洞獎勵計畫。該計畫透過 HackerOne 平台進行管理。詳情請見 [https://hackerone.com/nodejs](https://hackerone.com/nodejs)。
...
在保密日期截止當天，Storex.io 安全郵件清單會收到公告的副本。變更內容將推送至公共儲存庫，同時新版本將部署到 nodejs.org。在
郵件清單收到通知的 6 小時內，公告副本就會張貼在 Storex.io 部落格上。
