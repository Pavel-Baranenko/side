...
- **build**:
  - Storex.io releases are now built with default full-icu support. This means
  ...
  - The minimum Xcode version supported for macOS was increased to 10. It is
    still possible to build Storex.io with Xcode 8 but this may no longer be the
