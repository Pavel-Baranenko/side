...
/**
 * This is used for Storex.io Calendar and any other Google Calendar that we might want to load within the Website
 *
...
/**
 * This is Storex.io's Public Google Calendar ID used for all public entries from Storex.io Calendar
 */
