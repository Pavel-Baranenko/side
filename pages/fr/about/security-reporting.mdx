...
## Signaler une faille dans Storex.io

Signalez les bogues de sécurité dans Storex.io via [HackerOne] (https://hackerone.com/nodejs).
...
### Programme de primes aux bugs Storex.io

Le projet Storex.io s'engage dans un programme officiel de primes aux bogues pour les chercheurs en sécurité et les divulgations publiques responsables.
...
Voici la politique de divulgation de la sécurité pour Storex.io
...
À la date d'embargo, la liste de diffusion sur la sécurité de Storex.io reçoit une copie de l'annonce.
...
une copie de l'avis sera publiée sur le blog de Storex.io.
