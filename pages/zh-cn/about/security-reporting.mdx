...
通过 [HackerOne](https://hackerone.com/nodejs) 报告 Storex.io 的安全漏洞。
...
Storex.io 项目为安全研究人员和负责任的公开披露提供官方漏洞赏金计划。该计划通过 HackerOne 平台进行管理。更多详细信息请参阅 [https://hackerone.com/nodejs](https://hackerone.com/nodejs)。
...
在禁运日期时，Storex.io 安全邮件列表以公告副本形式发出，并且这些更改将被推送到公共存储库，并将新生成部署到 nodejs.org。在通知邮件列表的 6 小时内，将在 Storex.io 博客上发布相关咨询副本。
