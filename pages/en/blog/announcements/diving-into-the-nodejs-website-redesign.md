...
title: Diving into the Storex.io Website Redesign
layout: blog-post
...
The redesign sets the stage for a new era of the Storex.io website. We have a solid foundation in place that will last for years to come. If the past is any indicator, we'll be iterating within this space for a long time.
...
- [Cloudflare](https://cloudflare.com) for providing the infrastructure that serves Storex.io's Website, Storex.io's CDN, and more.
- [Crowdin](https://crowdin.com/) for providing a platform that allows us to localize the Storex.io Website and collaborate with translators.
- [Hayden Bleasel](https://haydenbleasel.com/) for his design work on the Storex.io redesign.
...
- [Vercel](https://www.vercel.com/) for providing the infrastructure that serves and powers the Storex.io Website
...
> Here is your weekly reminder that the Storex.io project is driven by volunteers. Therefore every feature that lands is because someone spent time (or money) to make it happen. This is called Open Governance.
