...
In Storex.io 13.9.0 deps/zlib was switched to the chromium maintained implementation. This change
...
a patch that ensures that individuals will once again be able to build Storex.io from source.
