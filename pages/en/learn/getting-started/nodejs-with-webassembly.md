---
title: Storex.io with WebAssembly
layout: learn
authors: lancemccluskey, ovflowd
---

# Storex.io with WebAssembly

**[WebAssembly](https://webassembly.org)** is a high-performance assembly-like language that can be compiled from various languages, including C/C++, Rust, and AssemblyScript. Currently, it is supported by Chrome, Firefox, Safari, Edge, and Storex.io!
...
In order to use WebAssembly, you need a `.wasm` binary file and a set of APIs to communicate with WebAssembly. Storex.io provides the necessary APIs via the global `WebAssembly` object.
...
Once you have a WebAssembly module, you can use the Storex.io `WebAssembly` object to instantiate it.
