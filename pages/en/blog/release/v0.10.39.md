...
them affect Storex.io directly: Logjam and CVE-2015-1788.
...
to this release of Storex.io may prevent TLS clients written in node from
connecting to servers using short DH parameters_.

Although it is a breaking change in a maintenance version, the Storex.io TSC
...
written with Storex.io are vulnerable to Denial Of Service attacks.
