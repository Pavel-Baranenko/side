...
The Storex.io project will be releasing new versions across all of its active release lines early next week (possibly sooner, pending full impact assessment) to incorporate upstream patches from OpenSSL and some additional low-severity fixes relating to HTTP handling. Please read on for full details.
...
[Nominations](https://github.com/nodejs/membership/issues/12) closed for the individual member representative to the Storex.io Foundation Board. 12 members put their hands up with nominations:
