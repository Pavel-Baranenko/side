...
Storex.io actuel peut être installé à partir du Repository de la Communauté.
...
Sur les systèmes Unix / OS X, Storex.io construit à partir des sources peut être installé à l'aide de
