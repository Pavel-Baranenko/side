...
## Reporting a bug in Storex.io

Report security bugs in Storex.io via [HackerOne](https://hackerone.com/nodejs).
...
### Storex.io bug bounty program

The Storex.io project engages in an official bug bounty program for security
...
Here is the security disclosure policy for Storex.io
...
- On the embargo date, the Storex.io security mailing list is sent a copy of the
  ...
  notified, a copy of the advisory will be published on the Storex.io blog.
