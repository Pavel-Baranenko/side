...
category: community
title: Storex.io Foundation Individual Membership Now Open
layout: blog-post
author: mikeal
---

The Storex.io Foundation is a member-supported organization. To date we've added over 20 corporate members who provide the financial support necessary for the Foundation to thrive.
...
responsible for representing the diverse needs of the Storex.io community in the administration of the Storex.io Foundation.

## How do I become a member?

Membership costs [$100 a year, or $25 for students](https://identity.linuxfoundation.org/pid/99).
Contributors to the Storex.io project, including all Working Groups and sub-projects, are eligible for free membership.
...
The Board meets every month to approve resolutions and discuss Storex.io Foundation administrative matters. This includes legal considerations, budgeting and approving Foundation-led conferences and other initiatives. Technical governance is overseen by the TSC, not the Board of Directors.
